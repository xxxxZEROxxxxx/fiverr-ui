const Footer = () => {
  return (
    <div className="footer flex justify-center text-[#999] my-[50px] ">
      <div className="w-[1200px]  ">
        <div className="top flex justify-between mt-5 font-light">
          <div className="item flex flex-col gap-4">
            <h2 className="text-[#2e2d2d ] text-[16px] font-bold">
              Categories
            </h2>
          ...
          <div className="item flex flex-col gap-4">
            <h2 className="text-[#2e2d2d ] text-[16px] font-bold">About</h2>
          ...
          <div className="item flex flex-col gap-4">
            <h2 className="text-[#2e2d2d ] text-[16px] font-bold">Support</h2>
          ...
          <div className="item flex flex-col gap-4 ">
            <h2 className="text-[#2e2d2d ] text-[16px] font-bold">Community</h2>
        ...
        <div className="bottom flex items-center justify-between">
          <div className="left flex items-center gap-5">
            ...
            <span className="text-[13px] text-gray-400">© Alaa International Ltd. 2023</span>
          </div>
          <div className="right flex items-center   ">
            <div className="social flex items-center gap-4">
              ...
              <ul className="social flex items-center gap-4 ">
                <li>
                  <a
                    href="https://www.tiktok.com/@fiverrcreates"
                    target="_blank"
                    rel="noopener"
                ...
                <li>
                  <a
                    ...
                    rel="noopener"
                    className="social-link"
                    aria-label="Fiverr on Instagram"
                  >
                ...
                <li>
                  <a
                    ...
                    rel="noopener"
                    className="social-link"
                    aria-label="Fiverr on Pinterest"
                  >
                    <span className="w-5 h-5" aria-hidden="true">
                      <svg
                        width="20"
              ...
              <img className="w-6 h-6" src="/img/accessibility.png" alt="" />
            </div>
          </div>
        </div>
      </div>
